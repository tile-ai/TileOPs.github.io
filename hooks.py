...
def on_page_markdown(markdown, page, config, files):
    ...
    elif src == "skills/catalog.md":
        # Catalog links to .claude/skills/<name>/SKILL.md → local guide page.
        markdown = _SKILL_LINK.sub(r"\1.md", markdown)

    elif src.startswith("skills/") and src != "skills/index.md":
        # Per-skill guide pages embed SKILL.md, which links to design docs
        # via ../../../docs/design/ and to sibling skills via ../<name>/SKILL.md.
